...
export const blogPosts = [
    { id: "1", 
      ...
      title: <><p>Orient Blue Ray II <br></br> El Mejor Diver por Menos de 200 Euros</p></>, 
      summary: <><p>Un diver polivalente, de mecánica japonesa y con una robustez inmejorable.</p></>, 
      editor: 'Lluis M.',
      date: '5 Feb, 2024',
      mainPicture: '/IMG_6515.jpg',
      content: <><p>
        ...
        <figure className="flex justify-center my-8">
          ...
          <p className="text-justify">
            El Orient Blue Ray II tiene un diámetro de 41,5 mm, 48,5 mm de punta a punta y 13 mm de grosor, medidas bastante contenidas para un diver. Lleva una maquinaria original de Orient llamada F6922, con una precisión registrada de fábrica de aproximadamente +-15 segundos al día y una reserva de marcha de unas 40 horas con complicación de día y fecha.          <br></br>
            <br></br>
        ...
        <figure className="flex justify-center my-8">
          ...
          <p className="text-justify">
            El cierre no es nada seguro, una vez incluso me saltó sin darme cuenta y perdí el reloj durante un par de días. Lo que quiero decir es que con un reloj de este precio no se puede pedir mucho más y la correa de caucho que viene de serie es de suficiente buena calidad y mucho más cómoda. Además, con la opción de caucho en Amazon, se ahorrarán unos 30 euros, que pueden usar para comprar una buena nato o una correa de caucho de mejor calidad, como acabé haciendo yo igualmente.          <br></br>
          </p>
        <figure className="flex justify-center my-8">
          <Image
            alt="Minimalist lifestyle"
          ...
          <p className="text-justify">
          Como objetivo personal, me he propuesto sumergirme con él en todos los mares y océanos del mundo, una experiencia que espero poder compartir con las generaciones futuras de mi familia, porque si cuido este reloj, sin duda me sobrevivirá.      
        </p>
        <figure className="flex justify-center my-8">
          <Image
            alt="Minimalist lifestyle"
    ...
    //{ id: "2", title: 'Second Post', summary: <><p>This is the second post.</p></>, mainPicture: '/IMG_6515.jpg' },
